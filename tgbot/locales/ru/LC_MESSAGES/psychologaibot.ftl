...
win-aboutme-name-h = { emoji-i-hi } { txt-name-before }

win-aboutme-name-txt = { emoji-check } Приятно, если ко мне обращаются так, как мне это нравится { emoji-hands-handshake }.

win-aboutme-name-error = <b>{ emoji-i-wrong } Я ошибся:</b>
