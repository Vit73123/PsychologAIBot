...
win-aboutme-profile-name = <b>Теперь моё имя: { emoji-i-am } { emoji-i-hi }</b>
...
btn-getback = Назад { emoji-getback }
...
btn-start-psychology = Сеанс с психологом { emoji-psychologist-man }
