...
class UserRepo:
    ...
    async def get_user_by_user_id(self, session: async_sessionmaker, tg_user_id: int) -> User:
    ...
    async def insert_user(self, session: async_sessionmaker, tg_user: types.User) -> User:
