...
@router.message(Command(commands='stat-s'))
...
@router.message(Command(commands='stat-g'))
...
@router.message(Command(commands='stat-gg'))
...
@router.message(Command(commands='stat-a'))
...
@router.message(Command(commands='stat-d'))
...
@router.message(Command(commands='stat-u'))
...
@router.message(Command(commands='stat-gs'))
