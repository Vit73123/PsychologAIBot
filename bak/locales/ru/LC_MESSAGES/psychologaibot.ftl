...
win-aboutme = <b>О себе: кто вы и как ваше самочувствие?</b>
    ...
    📌 <i>Вы можете пройти психологический тест, чтобы составить свой психологический портрет.</i>
    <i>Бот будет использовать ваши данные в общении с вами и лучше понимать вас. [new ❌]</i>
...
srv-checkname = ^[а-яА-ЯёЁ ]+
srv-anonimname = Новый пользователь