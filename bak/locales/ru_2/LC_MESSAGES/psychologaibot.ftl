...
win-start = <b>Добро пожаловать в Бот психологической поддержки!</b>
    ...
    Выбирайте:
    {$emoji-pin} <b>Сеанс с психологом</b> - пообщайтесь с психологом {$emoji-psychologist}
    {$emoji-pin} <b>Тесты</b> - пройдите тесты и узнайте больше о себе <b>[скоро!] {$emoji-soon}</b>
    {$emoji-pin} <b>О себе</b> - добавьте информацию о себе {$emoji-tests},
    составьте свой психологический профиль <b>[скоро!] {$emoji-soon}</b>
...
win-aboutme = <b>О себе: кто вы и как ваше самочувствие?</b>
    ...
    {$emoji-pin} Вы можете пройти психологический тест, чтобы составить свой психологический портрет. {$emoji-psychologist}
    Бот будет использовать ваши данные в общении с вами и лучше понимать вас. <b>[скоро!] {$emoji-soon}</b>
...
win-aboutme-profile-name = <b>Моё имя: {$emoji-i-hi}</b>
    ...
    {$emoji-checkit} Ко мне будут обращаться так, как я представлюсь.

win-aboutme-profile-name-error = <b>Я ошибся: {$emoji-i-wrong}</b>

    {$emoji-checkit} В имени не должно быть ничего лишнего:
    цифры, знаки и т.п., {$emoji-i-oh}

win-aboutme-profile-age = <b>Солько мне лет: {$emoji-i-hi}</b>

    {$emoji-checkit} Возраст всегда присутствует в общении.

win-aboutme-profile-age-error = <b>Я ошибся: {$emoji-i-wrong}</b>

    {$emoji-checkit} Вряд ли мне меньше 5 или больше 150 лет,
...
win-aboutme-profile-status = <b>Хочу рассказать, что для меня сейчас важнее всего: ‼</b>
    ...
    {$emoji-checkit} В настоящее время и в ближайщем будущем - лично для меня и моего самочувствия?
    {$emoji-checkit} Какую проблему решаем?
    {$emoji-checkit} Что направляет мои мысли, мои эмоции, мои действия?
    {$emoji-checkit} Есть ли проблема, которая беспокоит меня больше всего?
    {$emoji-checkit} Как я чувствую себя в целом, как настроение?
...
btn-getback = Вернуться {$emoji-getback}
...
btn-start-psychology = Сеанс с психологом {$emoji-psychologist}
btn-start-tests = Тесты {$emogi-tests}
